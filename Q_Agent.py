...
class QLearningAgent:
    ...
    def update_q(self, state, action, reward, q_max):
        ...
        print(f"q = {self.q_value[(state, (action[0], action[1]))]}, {(action[0], action[1])}")
    ...
    def get_action(self, state):
        ...
        if Helpers.chooseRandom(self.epsilon):
    ...
    def final(self, state):
        ...
        if self.get_episodes_so_far() % 2 == 0:
            print(f"№ episode {self.get_episodes_so_far()}")
